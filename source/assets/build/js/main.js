...
/* harmony import */ var _lang_en_en_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../lang/en/en.json */ "./source/lang/en/en.json");
var _lang_en_en_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./../../lang/en/en.json */ "./source/lang/en/en.json", 1);
/* harmony import */ var _lang_fr_fr_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../../lang/fr/fr.json */ "./source/lang/fr/fr.json");
var _lang_fr_fr_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./../../lang/fr/fr.json */ "./source/lang/fr/fr.json", 1);
...
i18next__WEBPACK_IMPORTED_MODULE_1__["default"].init({
  ...
  resources: {
    en: {
      translation: _lang_en_en_json__WEBPACK_IMPORTED_MODULE_2__
    },
    fr: {
      translation: _lang_fr_fr_json__WEBPACK_IMPORTED_MODULE_3__
    }
  }
}, function (err, t) {// initialized and ready to go!
  //console.log(err);
});
...
window.langRessources = function () {
  return {
    currentLang: "en",
    lang: getRessourceByLang(i18next__WEBPACK_IMPORTED_MODULE_1__["default"], "en"),
    changeLanguage: function changeLanguage(lang) {
      this.currentLang = lang;
      this.lang = getRessourceByLang(i18next__WEBPACK_IMPORTED_MODULE_1__["default"], this.currentLang);
    }
  };
};

function getRessourceByLang(ressources, lang) {
  var _ressources$getDataBy = ressources.getDataByLanguage(lang),
      translation = _ressources$getDataBy.translation;
...
module.exports = JSON.parse("{\"header\":{\"name\":\"Santos Pierre\",\"job\":\"Web Developer\",\"description\":\"Passionate developer, favorite stack at the moment is TALL (TailwindCSS, AlpineJs, Livewire, Laravel). Learning everyday from my experiences to discover all the time.\",\"nav\":{\"experience\":\"Experiences\",\"projects\":\"Projects\",\"contact\":\"Contact Me\"}}}");

/***/ }),

/***/ "./source/lang/fr/fr.json":
/*!********************************!*\
  !*** ./source/lang/fr/fr.json ***!
  \********************************/
/*! exports provided: header, default */
...
module.exports = JSON.parse("{\"header\":{\"name\":\"Santos Pierre\",\"job\":\"Développeur Web\",\"description\":\"Développeur passionné, mes technologies favorites en ce moment : TailwindCSS, AlpineJs, Livewire et Laravel. Apprendre tout les jours de mes expériences pour découvrir toujours plus\",\"nav\":{\"experience\":\"Expériences\",\"projects\":\"Projets\",\"contact\":\"Contactez Moi\"}}}");
